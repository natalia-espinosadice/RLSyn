...
if __name__ == '__main__':
    ...
    original_patient_filename = 'all_patients_8_24.0h_3.0h_False_True.csv'
    ...
    if model_id == 'real':
        ...
        syn_data = np.load(f'GAN_training/syn/emrwgan_model_{model_id}_ckpt_{ckpt_id}.npy',allow_pickle=True)
